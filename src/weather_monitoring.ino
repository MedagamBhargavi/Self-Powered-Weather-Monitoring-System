...
void loop() {
  ...
  ThingSpeak.setField(3, pressureBMP);       // Field 2: BMP280 Pressure
  ThingSpeak.setField(2, humidityDHT);       // Field 3: DHT11 Humidity
  //ThingSpeak.setField(1, temperatureDHT);    // Field 4: DHT11 Temperature
  ThingSpeak.setField(4, rainValue);         // Field 5: Rain Sensor Value
